...
function mostraDettagliCarta1(){
    const urlParams = new URLSearchParams(window.location.search);
    const username = urlParams.get("username");
    window.location.href = "cartaDettagli.html?username="+username+"&carta="+0;
}

function mostraDettagliCarta2(){
    const urlParams = new URLSearchParams(window.location.search);
    const username = urlParams.get("username");
    window.location.href = "cartaDettagli.html?username="+username+"&carta="+1;
}

function mostraDettagliCarta3(){
    const urlParams = new URLSearchParams(window.location.search);
    const username = urlParams.get("username");
    window.location.href = "cartaDettagli.html?username="+username+"&carta="+2;
}

function mostraDettagliCarta4(){
    const urlParams = new URLSearchParams(window.location.search);
    const username = urlParams.get("username");
    window.location.href = "cartaDettagli.html?username="+username+"&carta="+3;
}

function mostraDettagliCarta5(){
    const urlParams = new URLSearchParams(window.location.search);
    const username = urlParams.get("username");
    window.location.href = "cartaDettagli.html?username="+username+"&carta="+4;
}
